...
# Multi Threading - https://github.com/raj23manj/multithreading
  ...
  * Basic Multithreading - section 3
    ...
    * Semaphores - 19 & 20
      ...
      * Semaphore are used in situations for example an library with study rooms, which has front desk. If there are 10 rooms, and students want
        ...
        * Scenario 2: 
           when downloading we can use semaphores, wait until all units are complete and then do task on it 
           
        * Scenario 3:
          resctrict the number of people downloading an imgae, like 1000 only to download using acquire() the permits   
      ...
      * class Worker implements Runnable {
        ...
        public class CountDownLatches {
        	...
        	public static void main(String[] args) {
        		...
        		ExecutorService executorService = Executors.newSingleThreadExecutor(); // Executors.newFixedThreadPool(5);
    ...
    * Cyclic Barrier - 24
         ...
         * class Worker implements Runnable {
           	...
           	private void doWork() {
           		...
           		try {
           			cyclicBarrier.await(); // when the counter reaches zero, it calls the run method passed to the "CyclicBarrier"
           			System.out.println("After await..."); // once after the CyclicBarrier run method is called, then each thread continues it's execution
           ...
           O/P: Thread with ID 1 starts the task...
         ...
         * class FirstWorker implements Runnable {
           ...
           public class BlockingQueues {
           	...
           	public static void main(String[] args) {
           		...
           		BlockingQueue<String> queue = new ArrayBlockingQueue<>(10); // size of the queue
